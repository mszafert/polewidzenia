...
/** The template assigned to the node */
export type Template_Blogalternatywnie = ContentTemplate & {
  __typename?: 'Template_Blogalternatywnie';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_Pusto = ContentTemplate & {
  __typename?: 'Template_Pusto';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
export type ShowMenuItemsQueryVariables = Exact<{ [key: string]: never }>;

export type ShowMenuItemsQuery = {
  __typename?: 'RootQuery';
  menuItems?: {
    __typename?: 'RootQueryToMenuItemConnection';
    nodes: Array<{ __typename?: 'MenuItem'; id: string; label?: string | null }>;
  } | null;
};

export const ShowMenuItemsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ShowMenuItems' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<ShowMenuItemsQuery, ShowMenuItemsQueryVariables>;
